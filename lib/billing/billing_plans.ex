defmodule PayPal.Billing.BilllingPlans do
  @moduledoc """
  Documentation for PayPal.Billing.BilllingPlans
  """
  ...
  ## Examples
      ...
      iex> PayPal.Billing.BilllingPlans.list
      {:ok,
  ...
  ## Examples
      ...
      iex> PayPal.Billing.BilllingPlans.show(id)
      {:ok,
          %{create_time: "2017-05-02T08:04:20.411Z",
            description: "Plan with regular and trial payment definitions.",
            id: "P-3C560437P9994340RZAYE2OY",
  ...
  ## Examples
      ...
      iex> PayPal.Billing.BilllingPlans.create(plan)
      {:ok, plan}
  ...
  ## Examples
      ...
      iex> PayPal.Billing.BilllingPlans.update(id, plan)
      {:ok, plan}
