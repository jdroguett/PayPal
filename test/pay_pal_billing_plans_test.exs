defmodule PayPalBillingPlansTest do
  ...
  test "get billing plans" do
    use_cassette "billing_plans_get_plans" do
      resp = PayPal.Billing.BilllingPlans.list()
      assert resp == {:ok,
  ...
  test "create billing plan" do
    ...
    use_cassette "billing_plans_create_plan" do
      resp = PayPal.Billing.BilllingPlans.create(plan)
  ...
  test "get billing plan by ID" do
    ...
    use_cassette "billing_plans_get_plan" do
      resp = PayPal.Billing.BilllingPlans.show("P-3C560437P9994340RZAYE2OY")
  ...
  test "get billing plan by ID, not found" do
    use_cassette "billing_plans_get_plan_not_found" do
      resp = PayPal.Billing.BilllingPlans.show("P-3C560437P9994340RZAYE21X")
      assert resp == {:ok, nil}
    end
  end
  ...
  test "update a billing plan" do
    ...
    use_cassette "billing_plans_update_plan" do
      resp = PayPal.Billing.BilllingPlans.update("P-3C560437P9994340RZAYE2OY", op)
      assert resp == {:ok, nil}
    end
  end
  ...
  test "update a billing plan, error with malformed request" do
    ...
    use_cassette "billing_plans_update_plan_error" do
      resp = PayPal.Billing.BilllingPlans.update("P-3C560437P9994340RZAYE2OY", op)
      assert resp == {:error, :malformed_request, %{debug_id: "2418f505ab0db", information_link: "https://developer.paypal.com/webapps/developer/docs/api/#MALFORMED_REQUEST", message: "Incoming JSON request does not map to API request", name: "MALFORMED_REQUEST"}}
    end
  end
end
